package com.cinntra.indo.viewpager;
...
import com.cinntra.indo.customUI.CustomMarkerView;
import com.cinntra.indo.customUI.CustomMarkerViewReceivables;
import com.cinntra.indo.customUI.RoundedBarChart;
...
public class GraphPagerPurchaseAdapter extends PagerAdapter {
    ...
    public Object instantiateItem(@NonNull ViewGroup container, int position)
        ...
        if (position == 1)
            managebyShubhPayment(view, container,PurchaseDashBoardFragment.Paymententries);
        if (position == 2)
    ...
    private void managebyShubh(View view, ViewGroup container, List<BarEntry> entries)
        ...
        CustomMarkerView markerView = new CustomMarkerView(context, R.layout.barchart_marker, PurchaseDashBoardFragment.PurchaseValueForMarker);
    ...
    private void managebyShubhPayment(View view, ViewGroup container, List<BarEntry> entries)
            {
        ...
        CustomMarkerView markerView = new CustomMarkerView(context, R.layout.barchart_marker, PurchaseDashBoardFragment.PaymentValueForMarker);
