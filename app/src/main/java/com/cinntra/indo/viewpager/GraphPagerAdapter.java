...
import com.cinntra.indo.activities.MainActivity_B2C;
...
public class GraphPagerAdapter extends PagerAdapter {
    ...
    private void managebyShubhReceipt(View view, ViewGroup container, List<BarEntry> entries)
        ...
        CustomMarkerView markerView = new CustomMarkerView(context, R.layout.barchart_marker, MainActivity_B2C.ReceiptValueForMarker);
